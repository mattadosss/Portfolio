              ...
              <div className="max-w-5xl w-full bg-white rounded-2xl shadow-xl overflow-hidden md:flex">
                   ...
                   <div className="p-8 md:w-1/2">
                        ...
                        >
                             ...
                             <button
                                 type="submit"
                                 className="bg-[#f5d4d4] text-gray-800 px-6 py-2 rounded-lg hover:bg-pink-300 transition duration-300"
                             >
                                  Send Message
                             </button>
                        </form>
