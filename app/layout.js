    ...
    return (
        ...
        <footer className="bg-[#f5d4d4] text-black mt-auto font-[Geist] border-t border-[#e3a4a4]">
            <div className="w-full px-4 py-8 grid grid-cols-1 md:grid-cols-3 items-center gap-6 md:gap-10 text-center">
                ...
                <nav className="flex flex-wrap items-center justify-center md:justify-self-center divide-x divide-black">
                    <Link href="/" className="text-sm hover:underline px-3">Home</Link>
                    <Link href="/projects" className="text-sm hover:underline px-3">Projects</Link>
                    <Link href="/contact" className="text-sm hover:underline px-3">Contact</Link>
                </nav>
